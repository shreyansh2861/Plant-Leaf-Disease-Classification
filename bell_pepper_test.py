...
upload = Button(top, text="Choose a leaf image", command=upload_image,
                padx=10, pady=5)
...
heading = Label(top, text="Bell Pepper Leaf Disease Classification", pady=20, font=('arial', 20, 'bold'))
